...
New figure 1: To visually show the VC approximation, how about the
following. Make a 4x4 grid of atoms, with two different colors. Put an arrow
beside it, pointing to the same 4x4 grid where all the atoms are the same.
On the first grid, show the Gamma-point unit cell. On the second grid, show
the VC unit cell.
...
Both Si-Ge and GaN have relatively large 
...
results which lack for the alloys.
...
used. 
Quantify c ~ kB approximation, maybe with reference your SED paper?
