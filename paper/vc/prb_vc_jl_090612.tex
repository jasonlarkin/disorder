...
given by \cite{tamura_isotope_1983}:

The Rayleigh scattering limit is observed in the low-frequency limit, 
where the DOS is approximately Debye.
...
\bibliography{/home/jason/ntpl-ref/ntpl-jason/ntpl-jason}
\end{document}
