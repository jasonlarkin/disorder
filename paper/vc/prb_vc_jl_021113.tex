...
\tau\kv = \int_{0}^{\Tau} \frac{<E\kvt E\kvzero>}{ <E\kvzero E\kvzero> }dt,
\end{equation}
...
by moving to higher temerpature $T=40$ K in Fig. .
The beginning breakdown of the intrinsic phonon-phonon ($\tau_{p-p}\kw$) 
scattering model 
can be observed for $c=0.0$ at 
$T=40$ K (Fig. ), where ALD begins to overpredict compared to GK. 
This 
...
spectrum Fig. .(cite) Since the group velocities for VC-NMD and VC-ALD, 
...
from high-frequency modes is only a few percent (Fig. ). 
