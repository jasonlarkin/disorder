...
from equilibrium, $\dot{u}_{\alpha}$ is the $\alpha$- 
component of the atomic velocity, and $t$ is time.    
...
We perform the MD simulations using the fully disordered supercell 
...
% Also plotted is the GK predicted thermal conductivity of the amorphous 
% phase, which agrees well with the HS prediction $k_{HS}$ 
% [Eq. \eqref{EQ:M:k_AF,HS}].}
% \end{figure}
%--------------------------------------------------------------------------
...
system-sizes in Ref. [\citenum{he_lattice_2012}]). 
...
% of two modes at wavevector [0.25 0 0] calculated 
...
\bibliography{/home/jason/Dropbox/ntpl-paper/ntpl-032013}
\end{document}
