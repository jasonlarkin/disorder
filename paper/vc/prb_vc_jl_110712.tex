...
k_{HS} = (\frac{pi}{6})^(1/3) (\frac{3}{2}) k_{B} n_v^(2/3) v_s

k_{HS} = (\frac{pi}{6})^(1/3) (\frac{3}{2}) \frac{k_{B}}{V_b} v_s a
\end{equation}

which reveals the prediction for diffusivity in the high-scatter limit as
...
k_{HS} = (\frac{pi}{6})^(1/3) (\frac{3k_{B}}{2}) \frac{k_{B}}{V} bV_{b}^{1/3} v_s
(3/2)[ (pi/6)^(1/3) ] (kb/V) #V^(1/3) v_s = 

the characteristic (mode-averaged) diffusivity of this limit is

D_{HS} = (3/2)[ (pi/6)^(1/3) ] v_s a = 1.21 v_s a

lower limit of the AF calculation
