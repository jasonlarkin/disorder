...
Using broadband frequency domain thermoreflectance, 
...
negligibly to thermal conductivity. 
Using (to our knowledge) the largest model for bulk a-Si, 
we demonstrate that the 
low-frequency propagating mode lifetimes follow an 
$\omega^{-2}$ scaling.  
These low-frequency modes contribute significantly to thermal 
conductivity. For a-Si thin films, we consider two scalings of the 
low-frequency propagating mode lifetimes to predict the mean free paths.  
The thermal 
conductivity accumulation functions are predicted for a-SiO$_2$ and a-Si 
and compared with experimental results of 
Regner et al. and varying thin film measurements. Further 
