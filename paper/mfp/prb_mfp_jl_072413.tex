...
To remove metastability, all Both a-SiO2 and a-Si samples 
...
{/home/jason/disorder/si/amor/a288_init216.eps}
\vspace*{-5mm}
\end{center}
\caption{\label{FIG:supercell} 
(a) a sample supercell of a-SiO2 with $288$ atoms and supercell 
side length 1.597 nm. Samples up to  
$4,608 (36,864)$ atoms and side length $L4.026 (8.052)$ nm are 
used for the 
LD(MD)-based methods in Sections \ref{S:Life} and 
\ref{S:Diffusivities}. 
The samples were prepared using a melt-quench technique 
(see Section \ref{S:Sample}).
(b) a sample supercell of a-Si with $216$ atoms and side length 
1.086 nm. Samples up to size 
$4,096 (800,000)$ atoms and side length $4.344 (24.81)$ nm 
are used for the 
LD(MD)-based methods in Sections \ref{S:Life} and \ref{S:Diffusivities}. 
...
with time steps of dt = 0.905(0.5) fs for a-SiO$_2$(a-Si). 
...
discrepancy is, although in Ref \citenum{he_thermal_2011} 
...
based on Ref \citenum{baldi_thermal_2008} where the lowest frequency was limited 
