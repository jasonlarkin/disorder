...
\section{\label{S:Lifetimes}Lifetimes and MFPs of Vibrational Modes}
%--------------------------------------------------------------------------
...
Discuss normal mode decomposition and its limitations.
\cite{turney_predicting_2009-1} 

%If $\gamma \kv \gt \omega \kv$, then the vibrational mode is overdamped.  
Discuss why real-space method is necessary in this case.

\subsection{\label{S:Lifetimes:}Lifetimes of Disordered Vibrational Modes}

If determine by Ioffe-Regel limit, $\tau \kv < 1/\omega \kv$, Figure .
