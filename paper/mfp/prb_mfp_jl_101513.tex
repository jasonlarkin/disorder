...
\begin{document}
%--------------------------------------------------------------------------
\title{Thermal Conductivity Accumulation in a-SiO$_2$ and a-Si}
%--------------------------------------------------------------------------
...
bonded via shared oxygen atoms. The radial distribution function, 
$g(r)$,\cite{mcquarrie_statistical_2000} for the 4608 atom 
sample is shown in Fig. \ref{FIG:supercell} (a). 
Also shown in Fig. \ref{FIG:supercell} (a) is an experimental 
measurement of $g(r)$ from Ref. \citenum{lorch_neutron_1969} which 
...
measurement of $g(r)$ from Ref. \citenum{laaziri_high-energy_1999} 
...
Ref. \citenum{barkema_high-quality_2000}. 
...
{/home/jason/disorder/si/amor/m_sio2_rdf.eps}
\vspace*{-5mm}
\end{center}
...
Ref. \citenum{lorch_neutron_1969}. 
...
function compares well with the experimental measurement from 
Ref. \citenum{laaziri_high-energy_1999}. 
}
\end{figure}
%--------------------------------------------------------------------------
%\clearpage
...
show an $\omega^{2}$ scaling at low frequency, where the dashed lines 
indicate an extrapolation of the DOS based on this scaling. The DOS for 
...
These effects are not included in our model.
...
a lower limit for the lifetimes predicted by NMD. While lifetimes 
...
\begin{center}
\includegraphics[scale=1.0]
{/home/jason/disorder/si/amor/m_af_si_normand_4096_D_5.eps}
\vspace*{-5mm}
\end{center}
...
concentration (e.g. H, C, and O).
\cite{vacher_attenuation_1980,liu_high_2009,yang_anomalously_2010,
li_effect_2011} These effects are not included in our model. 
