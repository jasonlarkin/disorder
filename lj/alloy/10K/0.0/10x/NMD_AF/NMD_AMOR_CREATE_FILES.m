...
NMD.walltime.lammps = 24; NMD.cpu.lammps = 8; 
...
dummy =...
    dlmread(...
    strcat(NMD.str.main,'/x0_0_',int2str(NMD.seed.alloy),'.data'));
...
%output lammps    
    ...
    str.cmd8 =...
        ...
        '/lmp.in.x0.' int2str(NMD.seed.alloy)];
...
str.write=...
    strcat(...
    NMD.str.main,['/' int2str(NMD.seed.alloy) '/lmp.in.x0.' int2str(NMD.seed.alloy)]);
...
%NMD_ISEED_IKSLICE.sh------------------------------------------------------        
        ...
        str.cmd3 = ['-e ''s/\<' str.orig '\>/' str.change '/g'' '];
    str.cmd4 =...
        ['NMD.sh.temp > ./' int2str(NMD.seed.alloy) '/NMD_' int2str(iseed) '_' int2str(imode) '.sh'];
...
%NMD_ISEED_IKSLICE.m-------------------------------------------------------        
        ...
        str.cmd2 = ['-e ''s/\<' str.orig '\>/' str.change '/g'' '];
        str.cmd3 =...
            ['NMD.m.temp > ./' int2str(NMD.seed.alloy) '/NMD_' int2str(iseed) '_' int2str(imode) '.m'];
...
%NMD_grep.m-------------------------------------------------------        
    str.cmd3 = ['NMD.m.temp > ./' int2str(NMD.seed.alloy) '/NMD_' int2str(iseed) '_' int2str(imode) '.m'];
    str.cmd = ['sed ' str.cmd1 str.cmd2 str.cmd3];
    system(str.cmd);
