...
NMD_AF=load(strcat(str.NMD_AF,'/NMDdata.mat'));
SED_AF=load(strcat(str.NMD_AF,'/SEDdata.mat'));

str.NMD_X = '/home/jason/orderdisorder/lj/alloy/10K/0.0/8x/XCORR_AF/1';
NMD_X=load(strcat(str.NMD_X,'/NMDdata.mat'));
SED_X=load(strcat(str.NMD_X,'/SEDdata.mat'));
