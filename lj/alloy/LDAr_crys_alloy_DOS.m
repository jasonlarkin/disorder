...
AF05.alloy.freq = load(strcat(str.AF,'AF_freq_1.dat'));
AF05.alloy.Di =...
    load(strcat(str.AF,'Di(wi)_1.dat'));
AF05.alloy.x0 = load(strcat(str.AF,'x0_0.05_1.data'));
AF05.alloy.NUM_ATOMS = AF05.alloy.x0(1,1); 
AF05.alloy.NUM_ATOMS_UCELL = AF05.alloy.x0(1,2); 
AF05.alloy.Lx = AF05.alloy.x0(1,3); 
AF05.alloy.Ly = AF05.alloy.x0(1,4); 
AF05.alloy.Lz = AF05.alloy.x0(1,5);
AF05.alloy.VOLUME = AF05.alloy.Lx*AF05.alloy.Ly*AF05.alloy.Lz; 
AF05.alloy.dr = (AF05.alloy.VOLUME/AF05.alloy.NUM_ATOMS)^(1/3);
AF05.alloy.x0 = AF05.alloy.x0(2:size(AF05.alloy.x0,1),:);
