...
%--------------------------------------------------------------------------
    for iseed = 1:NMD.NUM_SEEDS
        str.read=...
            strcat(NMD.str.main,'/',int2str(NMD.seed.amor),'/NMD/SED_',...
...
save(...
    strcat(...
    NMD.str.main,'/',int2str(NMD.seed.amor),'/NMDavg.mat'), '-struct', 'NMD');
save(...
    strcat(...
    NMD.str.main,'/',int2str(NMD.seed.amor),'/SEDavg.mat'), '-struct', 'SED');
