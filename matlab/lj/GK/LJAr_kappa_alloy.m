...
%4
%0.1
Tset = [0.021093252*(eps_Ar/kb),0.063560512*(eps_Ar/kb),0.16025989*(eps_Ar/kb),0.5734263*(eps_Ar/kb)];
%0.5
Tset = [0.021093252*(eps_Ar/kb),0.063560512*(eps_Ar/kb),0.16025989*(eps_Ar/kb),0.5734263*(eps_Ar/kb)];

%4
%0.1
volset = [9.388569472e-27,9.442157446e-27,9.62102826e-27,1.046398563e-26];
...
for i2=1:length(Tset)
                ...
                volume = volset(i2);
            for i1=1:num_runs
                str_main=strcat('E:\CMU\work\Phonons\LJArgon\Solid\crystal\alloy\mass\0.1\0.9\');
