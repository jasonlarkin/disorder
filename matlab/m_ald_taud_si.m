...
sed8 = load('/home/jason/disorder2/si/alloy/0.5/8x/SEDdata.mat');
...
% subplot(2,1,2),...
% loglog(...
%     perfect_05(ipt).freq_bins,...
%     perfect_05(ipt).cond_freq,'.',...
%     [alloy_05(ipt).freq_bins(2)/2 alloy_05(ipt).freq_bins] ,...
%     [0 alloy_05(ipt).cond_freq] , '.'...
%     )
