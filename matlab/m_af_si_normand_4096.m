...
sio2.D(1,2).D = m_gulp_af_si_readDi('/home/jason/disorder2/sio2/alan/a288/tile/emin/','Di_b5.gout');
...
loglog(...
    ...
    sio2.SED(1,2).SED.HLDfreq(4:end),sio2.SED(1,2).SED.life(4:end)*1e-12,'.',...
...
sio2.debye.dos = 3*(sio2.debye.freq_range.^2)/(2*(0.78*siO2.vs_tran)^3*pi^2)*sio2.VOLUME(1,2);
...
%subplot(3,1,3),...
loglog(...
    sio2.D(1,2).dosx,sio2.D(1,2).dosy,...
...
subplot(2,1,2),...
loglog(...
    sio2.SED(1).SED.HLDfreq(12:end),((1/3))*siO2.vs_tran^2*(sio2.SED(1).SED.life(12:end)*1e-12),'.',...
    sio2.D(1,2).D(:,2),sio2.D(1,2).D(:,3),'.',...
    linspace(min(Di(8,10).Di(:,2)),max(Di(8,10).Di(:,2)),100),...
    (1/3)*(4.8E-10)*siO2.vs_tran*ones(100,1),...
    linspace(min(sio2.D(1,2).D(:,2)),max(sio2.D(1,2).D(:,2)),100),...
    sio2.debye.B*linspace(min(sio2.D(1,2).D(:,2)),max(sio2.D(1,2).D(:,2)),100).^(-2)...
    )
...
subplot(2,1,2),...
    loglog(...
    sio2.D(1,2).D(:,2),3*sio2.D(1,2).D(:,3)/siO2.vs_tran,...
    sio2.SED(1).SED.HLDfreq(12:end),siO2.vs_tran*(sio2.SED(1).SED.life(12:end)*1e-12),...
    linspace(min(sio2.D(1,2).D(:,2)),max(sio2.D(1,2).D(:,2)),100),...
    (31.4E-10)*ones(100,1),...
    linspace(min(sio2.D(1,2).D(:,2)),max(sio2.D(1,2).D(:,2)),100),...
    (4.7E-10)*ones(100,1)...
