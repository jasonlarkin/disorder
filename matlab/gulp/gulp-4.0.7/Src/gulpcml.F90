...
!============================================================================!
  ...
  call cmlAddParameter(cmlfile, name='use Pacha electronegativity equalisation method',&
          & value=(leem.and.lpacha),&
          & dictRef='gulp:Pachakey')
  ...
  call cmlAddParameter(cmlfile, name='use EEM electronegativity equalisation method - new parameters',&
          & value=(leem.and.(.not.((index(keyword,'oldeem').ne.0).or.lSandM.or.lqeq.or.lpacha))),dictRef='gulp:EEMkey')
...
!============================================================================!
  ...
  do i_atom = 1, natomp
    istring = ' '
    write(istring,*) i_atom
    do j_atom = 1, natomp
      jstring = ' '
      write(jstring,*) j_atom
