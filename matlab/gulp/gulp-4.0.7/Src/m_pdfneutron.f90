...
!
  if (lcoreinfo.and.ioproc) then
    ...
    do i = 1,ncfoc
      ...
      write(ioout,'("  Mass     = ", e11.4," kg")') arraymasses_kg(i) 
      write(ioout,'("  bbar     = ", e11.4," Ang")')  bbar_cores_A(i)
      write(ioout,'("  sigma_inc     = ",e11.4," Ang^2")') siginc_cores_A2(i)
      write(ioout,'("  Sigma_coh     = ",e11.4," Ang^2")') 4*pi*bbar_cores_A(i)*bbar_cores_A(i)
