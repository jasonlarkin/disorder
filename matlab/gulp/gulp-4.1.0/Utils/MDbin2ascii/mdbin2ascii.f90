...
!   7/12 Site energies added to match latest version
!
!  Conditions of use:
!
...
!
    ...
    enddo
!
    read(31,end=999,err=999) (siteenergy(i),i=1,numat)
    write(32,'(''#  Site energies'')')
    do i = 1,numat
      write(32,'(g25.15)') siteenergy(i)
    enddo
    if (lconp) then
