  subroutine lmbfgssub(iter,n,m,stp,g,diag,w,maxw,pvect)
!
...
!  11/12 Unused x argument removed
!
  use datatypes
  use iochannels
  implicit none
...
!
  INFO = 0
  iflag = 1_i4
  call functsync(iflag,niter,nrep,nrepptr,nvar,X,fcrep,G,tangent,F,nlower)
  DG = zero
  do j = 1,N
