...
!
  if (lEDIPpairOK(nzij)) then
    ...
    if (rij.lt.cutoff2) then
      rrij = 1.0_dp/rij
      call EDIP_expfn(rij,cutoff,EDIP2aprime(nzij),EDIP2sigma(nzij),exp1i,dexp1idrij,dexp1idZi,lgrad1)
...
!
  subroutine EDIP_expfn(rij,cutoff,aprime,sigma,exp2i,dexp2idrij,dexp2idZi,lgrad1)
!
