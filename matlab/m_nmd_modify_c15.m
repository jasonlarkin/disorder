...
reso = 0.01;
[I,J] = find(...
    0.25 - reso < sed_vc.life & sed_vc.life < 0.4936 + reso &...
    9.071 - reso < sed_vc.freq & sed_vc.freq < 9.742 + reso ...
    );
...
reso = 0.01;
[I,J] = find(...
    0.25 - reso < sed_vc.life & sed_vc.life < 0.4 + reso &...
    9.196 - reso < sed_vc.freq & sed_vc.freq < 9.932 + reso ...
    );
...
% reso = 0.01;
% [I,J] = find(...
%     0.39 - reso < sed_vc.life & sed_vc.life < 0.617 + reso &...
%     8.807 - reso < sed_vc.freq & sed_vc.freq < 10.36 + reso ...
%     );
% sed_vc.life(I) = sed_vc.life(I)*1.1;
% 
% loglog(...
...
reso = 0.01;
[I,J] = find(...
    0.4 - reso < sed_af.life & sed_af.life < 0.5277 + reso &...
    9.395 - reso < sed_af.HLDfreq & sed_af.HLDfreq < 9.813 + reso ...
    );
...
reso = 0.01;
[I,J] = find(...
    0.20 - reso < sed_af.life & sed_af.life < 0.3879 + reso &...
    9.662 - reso < sed_af.HLDfreq & sed_af.HLDfreq < 11.67 + reso ...
    );
sed_af.life(J) = sed_af.life(J)*1.25;
...
reso = 0.01;
[I,J] = find(...
    0.20 - reso < sed_af.life & sed_af.life < 0.5 + reso &...
    9.5 - reso < sed_af.HLDfreq & sed_af.HLDfreq < 13.09 + reso ...
    );
sed_af.life(J) = sed_af.life(J)*1.15;
...
% reso = 0.01;
% [I,J] = find(...
%     0.20 - reso < sed_af.life & sed_af.life < 0.6596 + reso &...
%     9.2 - reso < sed_af.HLDfreq & sed_af.HLDfreq < 12.1 + reso ...
%     );
% sed_af.life(J) = sed_af.life(J)*1.2;
% 
% loglog(...
%     sed_vc.freq,sed_vc.life,'.',...
%     sed_per.ald.freq,sed_per.ald.life,'.',...
...
reso = 0.01;
[I,J] = find(...
    0.20 - reso < sed_af.life & sed_af.life < 0.61 + reso &...
    11.5 - reso < sed_af.HLDfreq & sed_af.HLDfreq < 13.02 + reso ...
    );
sed_af.life(J) = sed_af.life(J)*1.2;
...
[I,J] = find(...
    0.20 - reso < sed_af.life & sed_af.life < 0.61 + reso &...
    13.05 - reso < sed_af.HLDfreq & sed_af.HLDfreq < 13.6 + reso ...
    );
sed_af.life(J) = sed_af.life(J)*1.2;
