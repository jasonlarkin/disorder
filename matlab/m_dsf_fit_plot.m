...
DSF(1).DSF = load([str_af 'DSF_long_100_b5.mat']);
DSF(2).DSF = load([str_af 'DSF_tran_100_b5.mat']);

DSF(3).DSF = load([str_af 'DSF_long_110_b5.mat']);
DSF(4).DSF = load([str_af 'DSF_tran_110_b5.mat']);

DSF(5).DSF = load([str_af 'DSF_long_111_b5.mat']);
DSF(6).DSF = load([str_af 'DSF_tran_111_b5.mat']);
