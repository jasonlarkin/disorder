...
clear
%--------------------------------------------------------------------------
    nmd.str.main = '/home/jason/disorder2/lj/alloy/40K/0.5/14x/' ;
...
%--------------------------------------------------------------------------
    nmd.x0.Nx = 14; nmd.x0.Ny = 14; nmd.x0.Nz = 14;
%--------------------------------------------------------------------------
    nmd.x0.alloy_conc = 0.5;
%--------------------------------------------------------------------------
    nmd.x0.mass(1) = 1.0; nmd.x0.mass(2) = 3.0; 
...
[nmd.x0.direct nmd.x0.cart nmd.x0.latvec nmd.x0.latvec_rec] =...
    m_lj_unit_cell_conv( nmd.x0.alat )
...
kpt = nmd.kptmaster(ikpt,:)./[nmd.x0.Nx nmd.x0.Ny nmd.x0.Nz];
    ...
    eigvec =...
        m_gulp_eig_lj(...
        kpt,nmd.x0.NUM_ATOMS_UCELL,nmd.lj.mass_au*nmd.x0.vm,...
	nmd.x0.alat*nmd.lj.sigma/nmd.constant.ang2m,...
...
change(6).str = num2str(nmd.x0.mass(1)*nmd.lj.mass);
...
m_change_file_strings(...
    ...
    change)
clear orig change
%outputs the atom_id type_id x y z for lammps input structure file
