...
Di(3,1).Di =...
    m_gulp_af_si_readDi(...
    '/home/jason/disorder2/si/amor/normand/init216/anneal/','Di_b1.gout');
VOLUME = (3*5.43E-10)^3;
cond(3,1) = (con.kb / VOLUME)*sum(Di(3,1).Di(:,3));
...
Di(3,20).Di =...
    m_gulp_af_si_readDi(...
    '/home/jason/disorder2/si/amor/normand/init216/anneal/','Di_b20.gout');
VOLUME = (3*5.43E-10)^3;
cond(3,20) = (con.kb / VOLUME)*sum(Di(3,20).Di(:,3));

Di(3,100).Di =...
    m_gulp_af_si_readDi(...
    '/home/jason/disorder2/si/amor/normand/init216/anneal/','Di_b100.gout');
VOLUME = (5*5.43E-10)^3;
