function sedald = m_joe_ald2nmd( nmd , sed , ald )
...
for ikpt = 1:nmd.NUM_KPTS
    ...
    I = find(...
        abs(sed.kpt((ikpt-1)*nmd.NUM_MODES+1,1))==abs(ald.kpt(:,1)) &...
        abs(sed.kpt((ikpt-1)*nmd.NUM_MODES+1,2))==abs(ald.kpt(:,2)) &...
        abs(sed.kpt((ikpt-1)*nmd.NUM_MODES+1,3))==abs(ald.kpt(:,3)) );
  
    if length(I)==0
        I = find(...
        abs(sed.kpt((ikpt-1)*nmd.NUM_MODES+1,1))==abs(ald.kpt(:,3)) &...
        abs(sed.kpt((ikpt-1)*nmd.NUM_MODES+1,2))==abs(ald.kpt(:,1)) &...
        abs(sed.kpt((ikpt-1)*nmd.NUM_MODES+1,3))==abs(ald.kpt(:,2)) );
    end
    if length(I)==0
        I = find(...
        abs(sed.kpt((ikpt-1)*nmd.NUM_MODES+1,1))==abs(ald.kpt(:,2)) &...
        abs(sed.kpt((ikpt-1)*nmd.NUM_MODES+1,2))==abs(ald.kpt(:,3)) &...
        abs(sed.kpt((ikpt-1)*nmd.NUM_MODES+1,3))==abs(ald.kpt(:,1)) );
    end
    if length(I)==0
        I = find(...
        abs(sed.kpt((ikpt-1)*nmd.NUM_MODES+1,1))==abs(ald.kpt(:,2)) &...
