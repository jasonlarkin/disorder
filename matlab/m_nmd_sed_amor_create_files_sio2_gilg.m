...
%--------------------------------------------------------------------------
    ...
    nmd.str.lmp_sed = 'lmp.in.sed.sio2.tmp';
    nmd.str.m_nmd = 'm_nmd_sed_gamma_sio2.m.tmp';
...
%replace double alloy
    I = find(nmd.mass(:,1) ==1); nmd.mass(I) = nmd.si.mass/nmd.constant.g2kg/nmd.constant.avog;
    I = find(nmd.mass(:,1) ==2); nmd.mass(I) = nmd.o.mass/nmd.constant.g2kg/nmd.constant.avog;
...
%output lammps    
    ...
    str.change = [num2str(nmd.si.mass)];
