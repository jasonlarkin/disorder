...
x.old =...
    m_x0_read('/home/jason/disorder/pcbm/pcbm_pdb/p2m1_1a1b1c/p2m1_1a1b1c.matlab');
...
new.CF.type = repmat(olps.mask.c60,1,4);
plot3(...
...
new.pcbm.type = repmat(olps.mask.pcbm28,1,4);
plot3(...
...
new.solvent.type = repmat(olps.mask.solvent.MCB,1,2);
plot3(...
