...
x.old =...
    m_x0_read('/home/jason/disorder/pcbm/pcbm_pdb/p1d1_2a2b2c/p1d1_2a2b2c.matlab');
olps = m_pcbm_olps;
NUM_OBJECT = 8*12;
...
new.solvent.type = repmat(olps.mask.solvent.oDCB,1,32);
plot3(...
...
dlmwrite(...
    '/home/jason/disorder/pcbm/pcbm_pdb/p1d1_2a2b2c.data',...
