...
m_dsf_plot_disp_110_createfigure(...
    dsf.long.freq_range(1:2000),...
    dsf.long.SL(1:2000,1),...
    dsf.long.freq_range(1000:3000),...
    dsf.long.SL(1000:3000,2),...
    dsf.long.freq_range(2000:4000),...
    dsf.long.SL(2000:4000,3),...
    dsf.long.freq_range(3000:5000),...
    dsf.long.SL(3000:5000,4),...
    dsf.long.freq_range(3000:8000),...
    dsf.long.SL(3000:8000,5),...
    dsf.tran.freq_range,...
    ...
    dsf.sed.freq(4,1);dsf.sed.freq(5,1)],...
    [0;dsf.long.kpt(:,1)]*nmd.Nx,...
    [0;dsf.sed.freq(1,2);dsf.sed.freq(2,2);dsf.sed.freq(3,2);...
