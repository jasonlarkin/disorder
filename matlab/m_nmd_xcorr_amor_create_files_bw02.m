...
%--------------------------------------------------------------------------
    ...
    nmd.str.lmp_sed = 'lmp.in.xcorr.lj.tmp';
...
%for nmd.seed.alloy=1:size(nmd.seed.alloy,2)
    ...
    str.cmd =...
        ['cp ' nmd.str.matlab 'lmp_submit.sh.tmp.bw02 ' ...
...
%lmp_ISEED.sh------------------------------------------------------        
    ...
    str.cmd4 = ['-e ''s/\<' str.orig '\>/' str.change '/g'' '];
    str.orig = 'NUM_CPU';
    str.change = [int2str(nmd.cpu.lammps)];
    str.cmd5 = ['-e ''s/\<' str.orig '\>/' str.change '/g'' '];
    
    str.cmd6 =...
        [nmd.str.matlab 'lmp.sh.tmp.bw02 > ' ...
        nmd.str.main 'lmp' int2str(iseed) '.sh'];
    
    str.cmd = ['sed ' str.cmd1 str.cmd2 str.cmd3 str.cmd4 str.cmd5 str.cmd6];
...
system(...
    ['cp ' nmd.str.matlab 'nmd.submit.sh.tmp.bw02 ' ...
...
%nmd_ISEED_IKSLICE.sh------------------------------------------------------        
        ...
        str.cmd3 = ['-e ''s/\<' str.orig '\>/' str.change '/g'' '];
        str.orig = 'NUM_CPU';
        str.change = [int2str(nmd.cpu.matlab)];
        str.cmd4 = ['-e ''s/\<' str.orig '\>/' str.change '/g'' '];
        
    str.cmd5 =...
        [nmd.str.matlab 'nmd.sh.tmp.bw02 > ' ...
...
%--------------------------------------------------------------------------
    ...
    str.cmd2 = [str.temp '|g'' '];
    str.cmd3 =...
        [nmd.str.matlab 'nmd_grep.sh.tmp.bw02 > ' ...
...
%--------------------------------------------------------------------------
system(...
    ['cp ' nmd.str.matlab 'nmd_grep_submit.sh.tmp.bw02 ' ...
...
%--------------------------------------------------------------------------
    ...
    str.cmd2 = [str.temp '|g'' '];
    str.cmd3 =...
        [nmd.str.matlab 'nmd_seed.sh.tmp.bw02 > ' ...
...
%--------------------------------------------------------------------------
system(...
    ['cp ' nmd.str.matlab 'nmd_seed_submit.sh.tmp.bw02 ' ...
