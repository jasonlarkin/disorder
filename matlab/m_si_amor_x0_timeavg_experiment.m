...
str.main =...
    '/home/jason/disorder2/si/amor/normand/perf4096/anneal_900K/';
...
icnt = 1;
data(icnt).data =...
    m_lmp_readdump_all([str.main 'lmp.x.nve.dump']);

log(icnt).log =...
    m_lmp_readlog([str.main 'log_main.lammps']);
