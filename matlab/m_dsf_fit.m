...
str_af = '/home/jason/disorder2/lj/alloy/10K/0.15/10x/work/';
...
DSF(1).DSF = load([str_af 'DSF_long_100_b20.mat']);
DSF(2).DSF = load([str_af 'DSF_tran_100_b20.mat']);

DSF(3).DSF = load([str_af 'DSF_long_110_b20.mat']);
DSF(4).DSF = load([str_af 'DSF_tran_110_b20.mat']);

DSF(5).DSF = load([str_af 'DSF_long_111_b20.mat']);
DSF(6).DSF = load([str_af 'DSF_tran_111_b20.mat']);
