...
# topotools example 2b:
# generate topology data from coordinate data
# build a box of 4x4x3 = 48 ethane molecules.
##############################################
...
topo writelammpsdata data.step2b full

# for easier testing and visualization, we
# also write out copies in .pdb and .psf format.
animate write pdb 48xethane.pdb
animate write psf 48xethane.psf
