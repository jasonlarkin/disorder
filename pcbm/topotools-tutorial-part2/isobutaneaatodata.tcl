...
# topotools example 2d:
# generate topology data from coordinate data
# build a box of 4x3x3 = 36 isobutane molecules.
##############################################
...
# and the hydrogen selection to get the hydrogens
# bound to it
$selc delete
set selc [atomselect top {index 4}]
# update charge for center carbon.
$selc set charge -0.060 ; # one hydrogen
...
topo writelammpsdata data.step2d full

# for easier testing and visualization, we
# also write out copies in .pdb and .psf format.
animate write pdb 36xisobutane.pdb
animate write psf 36xisobutane.psf
